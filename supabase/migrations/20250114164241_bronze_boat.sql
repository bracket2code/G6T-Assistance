...
BEGIN
  ...
  BEGIN
    INSERT INTO public.users (
      ...
      COALESCE(NEW.raw_user_meta_data->>'idNumber', NEW.id::text),
      default_role_id
    );
  EXCEPTION 
    WHEN unique_violation THEN
      ...
      UPDATE public.users SET
        ...
        id_number = COALESCE(NEW.raw_user_meta_data->>'idNumber', NEW.id::text)
      WHERE id = NEW.id;
    WHEN OTHERS THEN
...
SELECT 
  ...
  COALESCE(au.raw_user_meta_data->>'idNumber', au.id::text),
